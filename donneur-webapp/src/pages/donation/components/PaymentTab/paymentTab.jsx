    ...
    >
      ...
      <div className="w-full max-w-md px-5 pt-3 pb-6 h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button 
            onClick={onClose}
            className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 transition-colors focus:outline-none"
                ...
                <div className="w-full flex flex-col items-center justify-center py-6 space-y-4">
                  ...
                  <div className="relative w-full">
                    <div className="payment-methods-loader">
                      <div className="loader-card one">
                        <div className="loader-card-logo"></div>
                      </div>
                      <div className="loader-card two">
                        <div className="loader-card-logo"></div>
                      </div>
                      <div className="loader-card three">
                        <div className="loader-card-logo"></div>
                      </div>
                    </div>
                  </div>
